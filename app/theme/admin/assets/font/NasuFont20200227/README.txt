...
- version 2020.0227
  - 一部のアプリケーション（Microsoft Word, 一太郎）で縦書きが有効にならない対策。
    - fontforge-cygwin_2016_05_26 でTrueTypeフォントを開いて再保存。
    - ./fontforge/prefs を開き「CoverageFormatsAllowed:」の値を「1」にする。
  - TrueTypeヒント情報を削除する。
    - [Font > Generate Font > TrueType Option > Add Hint] をOFF。
...
- Windows 7 64bit
- unofficial fontforge-cygwin 2014_01_04 (FontForge 20140101＋縦書きパッチ）
- unofficial fontforge-cygwin_2016_05_26 (FontForge 20160507＋縦書きパッチ）
...
-- 
itouhiro <itouhiro at users dot osdn dot me>
