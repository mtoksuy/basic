	...
	public static function view_common_list_html_create($view_common_list_array, $file_word) {
		...
		foreach ($view_common_list_array as $key => $value) {
			if ($value === 'drawer.php') {
				...
				$now = '';
				if ($file_word == 'google_analytics.php') {
					$now = ' class="now"';
				}
				...
				$now = '';
				if ($file_word == 'navi_slide_menu.php') {
					$now = ' class="now"';
				}
