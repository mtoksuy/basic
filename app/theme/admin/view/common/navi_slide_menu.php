...
<div class="navi_slide_menu">
	<ul>
		<li<?php if (preg_match('/^\/amatem\/index.php$|^\/index.php$/', $_SERVER['PHP_SELF'], $array)) {
					echo ' class="now"';
				} ?>>
			<a href="<?php echo HTTP; ?>">ホーム</a>
			</li>
			<li<?php if (preg_match('/category|^\/products|^\/amatem\/products/', $_SERVER['REQUEST_URI'], $array)) {
						echo ' class="now"';
					} ?>>
				<a href="<?php echo HTTP; ?>category/">カテゴリー</a>
				</li>
				<li<?php if (preg_match('/cut_in_price_products/', $_SERVER['REQUEST_URI'], $array)) {
							echo ' class="now"';
						} ?>>
...
-->
					<li<?php if (preg_match('/newarticle|article/', $_SERVER['REQUEST_URI'], $array)) {
								echo ' class="now"';
							} ?>>
