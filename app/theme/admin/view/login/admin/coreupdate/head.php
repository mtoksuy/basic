<head>
	<title><?php echo 'コアアップデート｜アドミン｜ログイン' . '｜' . $site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<?php echo HTTP; ?>app/theme/admin/assets/css/login/admin/coreupdate/common.css" type="text/css">
</head>