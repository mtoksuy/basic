<head>
	<title><?php echo 'インポート｜アドミン｜ログイン' . '｜' . $site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<?php echo HTTP; ?>app/theme/admin/assets/css/login/admin/import/common.css" type="text/css">
</head>