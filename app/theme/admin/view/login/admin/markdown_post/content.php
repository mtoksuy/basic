...
<div class="markdown_editor">
	<div class="markdown_editor_inner">
		<form method="post" action="" class="post_form" style="<?php $is_mac = model_info_basis::is_mac();if(!$is_mac) {echo 'width: 75%;';}?>">
			...
			<input  type="hidden" value="<?php echo $preview_array['amatem_id']; ?>" name="amatem_id" id="amatem_id">
			<!-- 保存機能 -->
