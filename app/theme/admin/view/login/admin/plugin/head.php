<head>
	<title><?php echo 'プラグイン追加｜アドミン｜ログイン' . '｜' . $site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<?php echo HTTP; ?>app/theme/admin/assets/css/login/admin/plugin/common.css" type="text/css">
</head>