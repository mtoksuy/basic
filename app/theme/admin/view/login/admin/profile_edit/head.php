	<head>
	  <title>プロフィール設定｜アドミン｜<?php echo TITLE;?></title>
	  <!-- meta -->
	  <meta charset="UTF-8">
	  ...
	  <link rel="stylesheet" href="<?php echo HTTP;?>assets/css/login/admin/common.css" type="text/css">
	  <link rel="stylesheet" href="<?php echo HTTP;?>assets/css/login/admin/draft/common.css" type="text/css">
	  <link rel="stylesheet" href="<?php echo HTTP;?>assets/css/login/admin/profile_edit/common.css" type="text/css">
	</head>
