<head>
	<title><?php echo 'アドミン｜ログイン｜ポスト' . '｜' . $site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<?php echo HTTP; ?>app/theme/admin/assets/css/login/admin/post/common.css" type="text/css">
