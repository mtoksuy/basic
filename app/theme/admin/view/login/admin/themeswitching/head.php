<head>
	<title><?php echo 'テーマ切り替え｜アドミン｜ログイン' . '｜' . $site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8">
	...
	<?php /*admin_theme_color設定*/ if (!($site_data_array['admin_theme_color'] === 'default')) {
		echo '<link rel="stylesheet" href="' . HTTP . 'app/theme/admin/assets/css/admin_theme_color/' . $site_data_array['admin_theme_color'] . '.css" type="text/css">';
	} ?>
	<link rel="stylesheet" href="<?php echo HTTP; ?>app/theme/admin/assets/css/login/admin/themeswitching/common.css" type="text/css">
</head>