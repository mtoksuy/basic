<!DOCTYPE html>
<html>
	<?php require_once(PATH.'app/theme/'.$site_data_array['theme'].'/view/page/head.php'); /* head読み込み*/ ?>
	<body>
		<!-- wrapper -->
		<div class="wrapper">
			...
			<div class="main clearfix">
				...
				<div class="main_inner clearfix">
					<?php require_once(PATH.'app/theme/'.$site_data_array['theme'].'/view/page/content.php'); /* content読み込み*/ ?>
				</div>
			</div> <!-- main -->
			<?php require_once(PATH.'app/theme/'.$site_data_array['theme'].'/view/common/footer.php'); /* footer読み込み*/ ?>
		</div> <!-- wrapper -->
		<?php require_once(PATH.'app/theme/'.$site_data_array['theme'].'/view/page/head_footer.php'); /* head_footer読み込み*/ ?>
	</body>
</html>