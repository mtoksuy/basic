...
<head>
	<title><?php echo 'サイトマップ｜'.$site_data_array['title']; ?></title>
	<!-- meta -->
	<meta charset="UTF-8"/>
	...
	<link rel="stylesheet" href="<?php echo HTTP;?>app/theme/<?php echo $site_data_array['theme']; ?>/assets/css/sitemap/common.css" type="text/css"/>
