<!DOCTYPE html>
<html>
<?php require_once(PATH . 'app/theme/' . $site_data_array['theme'] . '/view/newarticle/head.php'); /* head読み込み*/ ?>
	...
	<div class="wrapper">
		...
		<div class="main clearfix">
			...
			<div class="main_inner clearfix">
				<?php require_once(PATH . 'app/theme/' . $site_data_array['theme'] . '/view/newarticle/content.php'); /* content読み込み*/ ?>
			</div>
		</div> <!-- main -->
