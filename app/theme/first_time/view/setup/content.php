					...
					<div class="contact">
						<div class="contact_inner">
							...
							<p class="contact_title_bottom">あまてむのご利用方法、相談etc.お気軽にご相談を</p>
							...
							<form method="post" action="" class="contact_form">
								...
								<div class="select">
										<select id="language" name="contact_content">
											...
											?>
											<option value="あまてむのご利用方法" <?php echo $selected_1; ?>>あまてむのご利用方法</option>
								...
								<input type="text" placeholder="e.g.) スペースナビ株式会社" value="<?php echo $_POST['company_name']; ?>" name="company_name" id="company_name">
