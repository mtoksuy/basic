		...
		<div id="nav-drawer">
			...
			<div id="nav-content">
				<ul>
					...
					<?php
					// カテゴリデータarray取得
					$category_res = model_sitemap_basis::category_res_get();
					// 全カテゴリーリストHTML生成
					$category_list_html = model_sitemap_html::category_list_html_create($category_res);
					?>
					<?php echo $category_list_html; ?>
				</ul>
				<ul>
					<p>私たちについて</p>
...
/*
							echo '
								<div class="search_window">
									<form class="search_window_form" method="get" action="'.HTTP.'search/" autocomplete="off">
										...
										<div class="search_logo">
											<img width="16" height="17" title="検索" alt="検索" src="'.HTTP.'assets/svg/common/search_logo_1.svg">
											<input type="submit" value="検索">
