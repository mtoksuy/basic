	<head>
	  <title>CDN自動変換ツール｜ガイド<?php echo '｜'.TITLE; ?></title>
	  <!-- meta -->
	  <meta charset="UTF-8">
	  ...
	  <link rel="stylesheet" href="<?php echo HTTP;?>assets/css/login/admin/direct/html_conversion_tool/common.css" type="text/css">
