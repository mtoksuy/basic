<!DOCTYPE html>
<html>
	<?php require_once(PATH.'view/newarticle/head.php'); /* head読み込み*/ ?>
	<body>
		<!-- wrapper -->
		<div class="wrapper">
			<?php require_once(PATH.'view/newarticle/header.php'); /* header読み込み*/ ?>
			<!-- navi_slide_menu -->
			...
			<div class="main clearfix">
				...
				<div class="main_inner clearfix">
					<?php require_once(PATH.'view/newarticle/content.php'); /* content読み込み*/ ?>
				</div>
			</div> <!-- main -->
