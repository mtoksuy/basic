	...
	<head>
		<title><?php echo 'あまてむ｜'.$product_title; ?></title>
		<!-- meta -->
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
		<!-- canonical -->
		<link rel="canonical" href="<?php echo HTTP.'products/'.$directory_name; ?>/">
		<!-- プロダクトJSON-LDリッチリザルト -->
		<?php echo $products_json_ld_rich_lizardo; ?>
		<!-- icon -->
		...
		<link rel="stylesheet" href="<?php echo HTTP;?>assets/css/privacy_policy/common.css" type="text/css">
		<link rel="stylesheet" href="<?php echo HTTP;?>assets/css/products/common.css" type="text/css">
