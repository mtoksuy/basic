	...
	<head>
		<title>webライター募集-2｜求人募集<?php echo '｜'.TITLE; ?></title>
		<!-- meta -->
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
		<!-- canonical -->
		<link rel="canonical" href="<?php echo HTTP; ?>recruit/writer/2/">
		<!-- icon -->
		...
		<link rel="stylesheet" href="<?php echo HTTP;?>assets/css/recruit/common.css" type="text/css">
