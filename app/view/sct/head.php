	<head>
		<title>特定商取引法に基づく表記<?php echo '｜'.TITLE; ?></title>
		<!-- meta -->
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
		<!-- canonical -->
		<link rel="canonical" href="<?php echo HTTP; ?>sct/">
		<!-- icon -->
		...
		<link rel="stylesheet" href="<?php echo HTTP;?>assets/css/sct/common.css" type="text/css">
