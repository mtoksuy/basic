	<head>
	  <title>設定｜アドミン｜UXSEOアナリティクス - SEO検索順位チェックツール</title>
	  <!-- meta -->
	  <meta charset="UTF-8">
	  ...
	  <link rel="stylesheet" href="<?php echo HTTP;?>assets/css/seo-tool/analytics/login/admin/common.css" type="text/css">
	</head>
